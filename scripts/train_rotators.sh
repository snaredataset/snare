...
## LAGOR rotator with and without final view est run for seeds 0 thru 9
...
EXP_FOLDER="rotators/exp_aug28_est_neither_seed_$RANDOM_SEED"
CUDA_VISIBLE_DEVICES=0 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 train.rotator.estimate_init_state=False train.rotator.estimate_final_state=False &
...
# EXP_FOLDER="rotators/exp_aug28_est_init_final_seed_$RANDOM_SEED"
# CUDA_VISIBLE_DEVICES=1 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 &
# EXP_FOLDER="rotators/exp_aug28_est_init_seed_$RANDOM_SEED"
# CUDA_VISIBLE_DEVICES=2 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 train.rotator.estimate_final_state=False &
# EXP_FOLDER="rotators/exp_aug28_est_final_seed_$RANDOM_SEED"
# CUDA_VISIBLE_DEVICES=0 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 train.rotator.estimate_init_state=False &
# EXP_FOLDER="rotators/exp_aug28_est_neither_seed_$RANDOM_SEED"
# CUDA_VISIBLE_DEVICES=1 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 train.rotator.estimate_init_state=False train.rotator.estimate_final_state=False &
...
# EXP_FOLDER="rotators/exp_aug28_est_init_final_seed_$RANDOM_SEED"
# CUDA_VISIBLE_DEVICES=2 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 &
# EXP_FOLDER="rotators/exp_aug28_est_init_seed_$RANDOM_SEED"
# CUDA_VISIBLE_DEVICES=0 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 train.rotator.estimate_final_state=False &
# EXP_FOLDER="rotators/exp_aug28_est_final_seed_$RANDOM_SEED"
# CUDA_VISIBLE_DEVICES=1 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 train.rotator.estimate_init_state=False &
# EXP_FOLDER="rotators/exp_aug28_est_neither_seed_$RANDOM_SEED"
# CUDA_VISIBLE_DEVICES=2 python train.py train.random_seed=$RANDOM_SEED train.exps_folder=$EXP_FOLDER train.feats_backbone=clip train.model=rotator train.max_epochs=50 train.aggregator.type=two_random_index train.rotator.pretrained_cls=$PRETRAINED_CLS train.lr=5e-5 train.rotator.estimate_init_state=False train.rotator.estimate_final_state=False &
